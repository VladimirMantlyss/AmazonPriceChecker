...
namespace CheckPrice
{
    class Program
    {
        ...
        public static void BuildDiagram(string leftColumName, string rightColumName, object[] arr1, object[] arr2, int? sizeW = 800, int? sizeH = 400)
        {
            ...
            {
                FileName = Base, // установите имя файла в URL-адрес
                UseShellExecute = true // используйте оболочку системы для запуска процесса
            };
        ...
        static async Task Main(string[] args)
        {
            ...
            PriceController priceController = new PriceController("C:\\Users\\admin\\Desktop\\Prices\\Info\\History\\");

            if (args.Length > 0) 
            {
                if (args[0] == "diagram") { BuildDiagram("Date", "Prices", FinalizeDate(Universalis("C:\\Users\\admin\\Desktop\\Prices\\Info\\History\\")), FinalizePrice(Universalis("C:\\Users\\admin\\Desktop\\Prices\\Info\\History\\"))); }
                else if (args[0] == "menu")
                {
                    string filePath = "C:\\Users\\admin\\Desktop\\Prices\\Info\\info.txt";
                    ...
                    while (true)
                    {
                        ...
                        if (choose == 1)
                        {
                            ...
                            string filePath2 = "C:\\Users\\admin\\Desktop\\Prices\\Info\\info.txt";
                        ...
                        else if (choose == 3)
                        {
                            ...
                            if (choose2 == 1)
                            {
                                BuildDiagram("Date", "Prices", FinalizeDate(Universalis("C:\\Users\\admin\\Desktop\\Prices\\Info\\History\\")), FinalizePrice(Universalis("C:\\Users\\admin\\Desktop\\Prices\\Info\\History\\")));
                            }
                            else if (choose2 == 2)
                            {
                                choose = 0;
                                ...
                                choose = int.Parse(Console.ReadLine());
                                BuildDiagram("Date", $"{productList[choose - 1].productType}", FinalizeDate(Universalis("C:\\Users\\admin\\Desktop\\Prices\\Info\\History\\")), FinalizePrice(Universalis("C:\\Users\\admin\\Desktop\\Prices\\Info\\History\\", choose + 1, 2)));
                            }
    ...
    class PriceController
    {
        ...
        public PriceController(string filepath)
        {
            ...
            this.filePath = filepath + $"Prices[{DateTime.Now.ToString("dd-MM-yyyy")}].xlsx";
        }
        ...
        {
            string path = @"C:\Users\admin\Desktop\Prices\Info\History\";
        ...
        public async Task AddProduct(string productType, string name, string link)
        {
            ...
            product.price = Double.Parse(System.Text.RegularExpressions.Regex.Match(response, @"<span class=""a-offscreen"">€([0-9]+\.[0-9]+)</span><span aria-hidden=""true""><span class=""a-price-symbol"">€</span><span class=""a-price-whole"">").Groups[1].Value, CultureInfo.InvariantCulture);
